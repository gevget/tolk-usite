export interface SlideContent {
  ...
  footer?: string;
  image?: string;
  type: 'hero' | 'dual' | 'list' | 'grid' | 'team' | 'clients' | 'cases' | 'cta' | 'manifest' | 'activities' | 'products' | 'conversion' | 'ideas';
  data?: any;
  customStyles?: {
    title?: any;
    subtitle?: any;
...
const LEGACY_SLIDES: SlideContent[] = [
  ...
  },
  {
    ...
    points: [
      { text: 'Заявки и статусы', icon: 'CheckCircle2', tooltip: 'Собираем личные кабинеты и рабочие интерфейсы, где клиент, дилер или сотрудник видит свои заявки, этапы, статусы и следующие действия без ручных уточнений.' },
      { text: 'Документы и прайсы', icon: 'FileText', tooltip: 'Выстраиваем единый контур документов, прайсов, спецификаций и коммерческих материалов, чтобы команда и клиенты работали с актуальными данными в одном месте.' },
      { text: 'Каталоги и остатки', icon: 'Layers', tooltip: 'Помогаем показывать номенклатуру, ассортимент, остатки и связанные сущности так, чтобы ими было удобно управлять внутри системы и использовать в продажах.' },
      { text: 'Роли и права', icon: 'ShieldCheck', tooltip: 'Проектируем доступы, роли и сценарии для разных типов пользователей: кто что видит, кто что редактирует и где проходит контроль важных действий.' },
      { text: 'Аналитику и маршруты', icon: 'LineChart', tooltip: 'Добавляем маршрутные сценарии, контроль этапов и аналитику, чтобы система не просто отображала данные, а реально вела пользователя по процессу.' },
      { text: 'AI-поиск и помощь сотрудникам', icon: 'Sparkles', tooltip: 'Встраиваем AI-поиск, подсказки и рабочую помощь прямо в интерфейс кабинета или внутренней системы, чтобы команда быстрее находила ответы и меньше переключалась между сервисами.' }
    ],
    data: {
        image: '/skill.png'
    },
  ...
  },
  {
    ...
    type: 'list',
    title: 'Наш главный скилл — кабинеты и системы',
    subtitle: 'Личные кабинеты, партнёрские платформы, дилерские и партнёрские системы — одна из наших самых сильных и прикладных компетенций.',
    points: [
      { text: 'Заявки и статусы', icon: 'CheckCircle2', tooltip: 'Собираем личные кабинеты и рабочие интерфейсы, где клиент, дилер или сотрудник видит свои заявки, этапы, статусы и следующие действия без ручных уточнений.' },
      { text: 'Документы и прайсы', icon: 'FileText', tooltip: 'Выстраиваем единый контур документов, прайсов, спецификаций и коммерческих материалов, чтобы команда и клиенты работали с актуальными данными в одном месте.' },
      { text: 'Каталоги и остатки', icon: 'Layers', tooltip: 'Помогаем показывать номенклатуру, ассортимент, остатки и связанные сущности так, чтобы ими было удобно управлять внутри системы и использовать в продажах.' },
      { text: 'Роли и права', icon: 'ShieldCheck', tooltip: 'Проектируем доступы, роли и сценарии для разных типов пользователей: кто что видит, кто что редактирует и где проходит контроль важных действий.' },
      { text: 'Аналитика и маршруты', icon: 'LineChart', tooltip: 'Добавляем маршрутные сценарии, контроль этапов и аналитику, чтобы система не просто отображала данные, а реально вела пользователя по процессу.' },
      { text: 'AI-поиск и помощь сотрудникам', icon: 'Sparkles', tooltip: 'Встраиваем AI-поиск, подсказки и рабочую помощь прямо в интерфейс кабинета или внутренней системы, чтобы команда быстрее находила ответы и меньше переключалась между сервисами.' }
    ],
    data: {
      image: '/skill.png'
  ...
  },
  {
    ...
    data: [
      {
        name: 'Михаил Юматов',
        role: 'Директор и основатель ЮСТ (с 2014). Экспертиза: архитектура сложных систем, оптимизация бизнес-процессов, облачные решения.',
        bio: 'Нижний Новгород/Москва. Директор и учредитель агентства ЮСТ с 2014 года. Основные компетенции — оптимизация бизнес-процессов, архитектура сложных информационных систем, полный цикл разработки облачных программных решений (SDO, CTO).\n\nНачальник факультета инженерных компетенций дополнительного образования Нижегородской области. Спикер НГТУ им. Р.Е. Алексеева по направлению «WEB-технологии». Действующий куратор региональных отборочных этапов всероссийских и международных мероприятий по направлениям Робототехника, Информатика, Беспилотные авиационные системы.'
      },
      {
        name: 'Евгений Толченков',
        role: 'Основатель студии Толк (с 2013). Экспертиза: продуктовая архитектура, UI/UX и дизайн-системы, стратегия и позиционирование.',
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        task: 'Интеллектуальная поддержка: кастомный ИИ-виджет с глубокой настройкой интерфейса и логики.',
        image: '/src/assets/images/yandex.jpg',
        fullContent: {
          title: 'Yandex Support AI',
          subtitle: 'Система поддержки с ИИ + полностью настраиваемый виджет',
      ...
      {
        client: 'Döcke (DSC)',
        task: 'Платформа закупок для партнёров: перевод процессов из звонков и ручных заказов в цифровую систему.',
        image: '/src/assets/images/dsc.jpg',
        fullContent: {
          title: 'DSC (Docke Supply Center)',
          subtitle: 'Платформа закупок строительных материалов для партнёров',
      ...
      {
        client: 'STOLKOM',
        task: 'Единая операционная система с ИИ для продаж, поддержки и маркетинга.',
        ...
        fullContent: {
          ...
          solution: [
            ...
            { text: 'База знаний + ИИ (обучаемые ответы)', icon: 'Brain' },
      ...
      },
      {
        ...
        fullContent: {
          ...
          solution: [
            ...
            { text: 'Подготовили основу для автоматизации и ИИ-надстроек', icon: 'Sparkles' }
          ],
  ...
  },
  {
    ...
    data: {
      ...
      future: {
        name: 'Моё будущее',
        projectUrl: 'https://gevget.github.io/myfuture/',
        ...
        fullContent: {
          title: 'Моё будущее',
          subtitle: 'ИИ-навигация склонностей школьников и кадровый прогноз',
          ...
          solution: [
            { text: 'Профориентационная логика на базе ИИ', icon: 'Brain' },
      ...
      smm: {
        name: 'smmбаза',
        projectUrl: 'https://gevget.github.io/smmbaza/',
...
const aiSystemsProduct = {
  name: 'AI Systems',
  info: 'Внутренние инструменты, ИИ-ассистенты и рабочие системы для поиска знаний, документов, поддержки команды и ускорения ежедневных процессов.',
  image: '/src/assets/images/ai.png',
  icon: 'Brain',
  fullContent: {
    title: 'AI Systems',
    subtitle: 'Внутренние ИИ-инструменты для поиска знаний, документов и поддержки команды',
    ...
    solution: [
      { text: 'ИИ-поиск по базе знаний и внутренним документам', icon: 'Brain' },
    ...
    keyFeature: 'ИИ встроен в рабочий процесс компании, а не существует как отдельная демонстрация ради галочки.',
    results: [
...
export const SLIDES: SlideContent[] = [
  {
    id: 'slide-1',
    type: 'hero',
    title: 'Строим сайты, ИИ-инструменты и цифровые системы для бизнеса',
    description: 'От сайта за 5 дней до личного кабинета, платформы или ИИ-помощника компании.',
    data: {
      eyebrow: 'Стратегия × продукт × ИИ × запуск',
      bullets: [
        'Сайты и цифровые продукты',
        'ИИ-ассистенты и внутренние системы',
        'Личные кабинеты и партнёрские платформы',
        'Первая версия и запуск новых продуктов'
      ],
    ...
    data: [
      {
        ...
        details: 'Авторский сайт, контент, подготовка к поисковому продвижению, запуск.',
        icon: 'Globe',
        image: '/src/assets/images/5 day.png'
      },
      {
        title: 'ИИ-ассистент компании',
        details: 'Поиск знаний, документы, продажи, поддержка команды.',
        icon: 'Bot',
        image: '/src/assets/images/ai as.png'
      },
      {
        title: 'Личный кабинет',
        details: 'Для клиентов, партнёров, сотрудников или дилеров.',
        icon: 'LayoutDashboard',
        image: '/src/assets/images/lk.png'
      },
      {
      ...
      {
        title: 'ИИ-аудит бизнеса',
        details: 'Находим потери времени, денег и точки роста.',
        icon: 'Search',
        image: '/src/assets/images/ai audit.png'
      },
      {
  ...
  },
  {
    ...
    points: [
      ...
      { text: 'Есть идея продукта, но непонятно как запускать', icon: 'Lightbulb', tooltip: 'Нужен не абстрактный разбор, а понятный маршрут первой версии: что проверить первым, что сделать руками, а что сразу автоматизировать.' },
  ...
  },
  {
    ...
    points: [
      ...
      'где ИИ и система реально дадут эффект'
    ],
    ...
    data: [
      {
        ...
        details: 'Что делаем первым, какие этапы, сроки и приоритеты.',
        icon: 'Globe',
        image: '/src/assets/images/1 roadmap.png'
      },
      {
        title: 'Сильную структуру продукта',
        details: 'Логика, сценарии и каркас будущей системы.',
        icon: 'Brain',
        image: '/src/assets/images/2 prod.png'
      },
      {
        title: 'Интерфейс, который объясняет',
        details: 'Дизайн без шума, с ясной навигацией и понятными действиями.',
        icon: 'LayoutDashboard',
        image: '/src/assets/images/3 ux.png'
      },
      {
      ...
      {
        title: 'Цифровой контур для команды',
        details: 'Кабинеты, роли, документы, данные и процессы в одном месте.',
        icon: 'Rocket',
        image: '/src/assets/images/5 cont.png'
      },
      {
        title: 'Базу для роста',
        details: 'Метрики, улучшения, новые сценарии и масштабирование дальше.',
        icon: 'Rocket',
        image: '/src/assets/images/6 baza.png'
      }
    ]
  },
  {
    id: 'slide-8',
    type: 'list',
    title: 'ИИ внутри решений, а не ради галочки',
    subtitle: 'Используем ИИ там, где он реально ускоряет работу.',
    points: [
      { text: 'поиск по базе знаний', icon: 'Search', tooltip: 'ИИ быстро находит ответы по регламентам, инструкциям, базе знаний и внутренним документам, не заставляя сотрудника идти по цепочке из чатов и ссылок.' },
      ...
      { text: 'работа с документами', icon: 'FileText', tooltip: 'ИИ помогает искать фрагменты, собирать сводки, вытаскивать смысл и ускорять работу с большими пакетами документов и файлов.' },
      ...
      { text: 'поддержка сотрудников', icon: 'Users', tooltip: 'Снижаем нагрузку на экспертов внутри компании: ответы, навигация, введение в работу и типовые подсказки доступны быстрее и ближе к месту работы.' },
      { text: 'аналитика и поиск информации', icon: 'BarChart3', tooltip: 'ИИ помогает находить закономерности, быстро собирать выводы и поднимать важную информацию наверх, когда времени на ручной анализ уже нет.' }
    ],
    data: {
      image: '/ai-inside.png'
    }
  },
  {
    id: 'slide-why',
    type: 'manifest',
    title: 'Почему Толк × ЮСТ',
    points: [
      { text: 'Основатели в проекте', icon: 'Flag', description: 'Основатели лично погружены в задачу и держат решение на уровне продукта, дизайна и реализации.' },
      ...
      { text: 'Сложные проекты', icon: 'Layers', description: 'Умеем работать с партнёрскими платформами, внутренними системами, кабинетами, интеграциями и длинными процессами принятия решений.' },
      { text: 'Гибко', icon: 'RefreshCw', description: 'Подстраиваем глубину работы под реальную стадию бизнеса: от быстрого сценария запуска до полноценной продуктовой системы.' }
    ],
    data: {
  ...
  },
  {
    ...
    description: 'Если у вас похожий контур задачи — сайт, кабинет, ИИ-инструмент или внутренняя система — покажем подход, сроки и маршрут запуска.',
    points: [
      'оценим задачу по реальному объёму',
      'предложим формат: быстрый запуск, первая версия или полноценную систему',
      'соберём понятный план работ'
    ],
  ...
  },
  {
    ...
    type: 'ideas',
    title: 'Наши идеи',
    description: 'Продукты, сервисы и системы, которые мы исследуем, прототипируем и превращаем в работающие решения.',
    footer: 'От гипотезы — к прототипу, пилоту и продукту.',
    data: {
      eyebrow: 'Продуктовая лаборатория',
      image: '/src/assets/images/generated-ideas-lab.webp',
      url: 'https://gevget.github.io/tolki/',
      ctaLabel: 'Смотреть идеи'
    }
  },
  {
    id: 'slide-extras',
    ...
    data: [
      { name: 'ИИ-аудит бизнеса', info: 'Находим потери времени, денег и точки роста.', icon: 'Search', tooltip: 'Смотрим, где ИИ действительно может ускорить работу бизнеса, а где сначала нужно чинить сам процесс и только потом автоматизировать.' },
      ...
      { name: 'Аудит сценариев и интерфейсов', info: 'Находим барьеры в сценариях и интерфейсах.', icon: 'Layout', tooltip: 'Разбираем интерфейс и путь пользователя, чтобы быстро найти места, где теряется внимание, понимание, деньги или конверсия.' },
      ...
      { name: 'Цифровая стратегия', info: 'Маршрут роста и приоритеты на ближайший цикл.', icon: 'Target', tooltip: 'Помогаем выбрать, что запускать сейчас, что отложить и где цифровой продукт или сайт реально даст бизнес-эффект в ближайший цикл.' },
      ...
      { name: 'Контент-дизайн', info: 'Тексты, смыслы и логика интерфейсов.', icon: 'Type', tooltip: 'Помогаем выстроить язык продукта: от структуры экрана и призывов к действию до текстов, которые объясняют сложное просто и уверенно.' },
      { name: 'Продуктовый план', info: 'План запуска и развития без лишней стройки.', icon: 'Route', tooltip: 'Собираем реалистичный маршрут: что делаем первым, что идёт во вторую очередь и где нужно проверять гипотезы до тяжёлой разработки.' },
      { name: 'Коммуникации для сложных продаж', info: 'Материалы и интерфейсы для сложных продаж.', icon: 'Megaphone', tooltip: 'Упаковываем продукт и точки контакта так, чтобы сложное решение было проще объяснять клиентам, партнёрам и внутренней команде.' },
...
if (!SLIDES.some((slide) => slide.id === 'slide-7')) {
  ...
  SLIDES.splice(insertIndex === -1 ? 0 : insertIndex, 0, {
    ...
    points: [
      ...
      { text: 'Роли и права', icon: 'ShieldCheck', tooltip: 'Проектируем доступы, роли и сценарии для разных типов пользователей: кто что видит, кто что редактирует и где проходит контроль важных действий.' },
      { text: 'Аналитика и маршруты', icon: 'LineChart', tooltip: 'Добавляем маршрутные сценарии, контроль этапов и аналитику, чтобы система не просто отображала данные, а реально вела пользователя по процессу.' },
      { text: 'ИИ-поиск и помощь сотрудникам', icon: 'Sparkles', tooltip: 'Встраиваем ИИ-поиск, подсказки и рабочую помощь прямо в интерфейс кабинета или внутренней системы, чтобы команда быстрее находила ответы и меньше переключалась между сервисами.' },
    ],
    data: {
      image: '/skill.png',
    },
